...
Welcome to my personal portfolio website — a clean, responsive web presence showcasing my skills, projects, and background as a full-stack developer.

---

## 🚀 About This Project  
This website is built to present who I am, what I can do, and what I’ve built.  
It serves as a digital portfolio for potential employers, collaborators, or clients to quickly get an overview of my work and contact information.

---

## ✨ Features  
- Responsive layout (works on mobile, tablet, desktop)  
- Home / Hero section with name and tagline  
- *About Me* section — short bio and background  
- *Projects* section — showcase of featured works (with short description, tech stack tags)  
- *Contact* section — contact info & call to action  
- Clean design using Tailwind CSS for styling  
...
- HTML5  
- Tailwind CSS  
- (Plain) JavaScript — minimal usage  
